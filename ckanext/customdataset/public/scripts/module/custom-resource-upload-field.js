 ...
 *
 */
this.ckan.module('custom-resource-upload-field', function (jQuery, _, i18n) {
  return {
    ...
    initialize: function () {
      ...
      // Grab our error display div tag by class name and assign it to a property of our module.
      this.div_error = this.$('.alert.fade.in.error-alert');
